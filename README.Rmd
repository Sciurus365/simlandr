...
b1 <- calculate_barrier(l1, start_location_value = -2, end_location_value = 2, start_r = 0.3, end_r = 0.3)
plot(l1) + get_geom(b1)

b2 <- calculate_barrier(l2, start_location_value = c(-2.5,-2), end_location_value = c(2.5, 0), start_r = 0.3, end_r = 0.3)
