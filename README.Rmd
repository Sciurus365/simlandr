...
2. Store large simulation outputs into hard drive by reusable `hash_big.matrix` class, and perform out-of-memory calculation;
3. Check convergence of the simulations;
4. Construct 2d, 3d, 4d potential landscapes based on the simulation outputs;
5. Calculate the lowest elevation path and barrier height for transitions between states.
