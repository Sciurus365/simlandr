...
#' batch simulation. Use `new_var_set` to create a `var_set`
#' object, and use `add_var` to add descriptions of variables.
#'
#' @describeIn new_var_set Create a `var_set`.
#'
...
#' @seealso [make_var_grid()] for making grids from variable sets;
...
#' @param var_list An `var_list` object generated by [fill_in_struct()].
#' @export
...
#'
#' @param var_grid A `var_grid` object. See [make_var_grid()].
...
#' `var_list` that contains all the variables; the second to the second
